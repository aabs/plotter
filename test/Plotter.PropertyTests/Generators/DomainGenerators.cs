...
public static class DomainGenerators
{
    ...
    private static Gen<NovelWorkspace> WorkspaceGenerator() =>
        ...
        select BuildWorkspace(participantIds, locationIds, sceneIds, stories);
        ...
        List<StoryTime> stories)
    {
        ...
        for (var index = 0; index < scenes.Length; index++)
        {
            ...
            workspace.Scenes[scenes[index].Value] = new Scene(scenes[index], $"Scene {index}", story, null, location, sceneParticipants);
        }
